export default function Nanny() {
    const services = [
        { name: "Uşaqlar üçün", image: "clean4.jpg" },
        { name: "Böyüklər üçün", image: "clean5.jpg" },
        { name: "Ev heyvanları üçün", image: "clean6.jpg" },
    ];

return (
    <div className="text-center text-2xl pt-[30px]">
        <h1 className="text-2xl font-semibold text-[#0073ce]">Dayə xidməti</h1>
